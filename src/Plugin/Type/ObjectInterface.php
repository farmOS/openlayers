...
namespace Drupal\openlayers\Plugin\Type;
...
interface ObjectInterface {
   ...
   * @param \Drupal\openlayers\Plugin\Type\ObjectInterface $context
   *   The context of the build. Mostly the map object.
   */
  public function preBuild(array &$build, \Drupal\openlayers\Plugin\Type\ObjectInterface $context = NULL);
   ...
   *   The context of the build. Mostly the map object.
   */
  public function postBuild(array &$build, \Drupal\openlayers\Plugin\Type\ObjectInterface $context = NULL);
}
